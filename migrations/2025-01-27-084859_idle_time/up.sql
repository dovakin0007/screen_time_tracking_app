CREATE TABLE app_idle_time_period (
    ...
    FOREIGN KEY (app_id) REFERENCES app_usage_time_period (id), -- Reference to total_app_usage_time table
...
CREATE INDEX idx_idle_periods_start_end_time ON app_idle_time_period (start_time, end_time);