...
mod tests {
    ...
    fn test_window_state_tracker() {
        ...
        state1.insert(ArcIntern::new("window1".to_string()), ArcIntern::new(WindowDetails::default()));
        ...
        state2.insert(ArcIntern::new("window2".to_string()), ArcIntern::new(WindowDetails::default()));
